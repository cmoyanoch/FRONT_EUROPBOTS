...
# Script para importar backup de la base de datos webapp (automático)
# Uso: ./import_webapp_auto.sh [archivo_backup]
...
echo -e "${BLUE}=====================================================${NC}"
echo -e "${BLUE}🗄️  IMPORTADOR AUTOMÁTICO DE BACKUP WEBBAPP${NC}"
echo -e "${BLUE}=====================================================${NC}"
