...
export default function LeadsPage() {
  ...
  const fetchLeads = async () => {
    try {
      ...
      if (data.success) {
        ...
        setError(data.error || "Erreur lors du chargement des leads");
      }
    } catch (err) {
  ...
  // Función para obtener el orden de prioridad del estado
                ...
                {loading ? (
                  <tr>
                    <td colSpan={3} className="px-6 py-12 text-center">
                      <Loader2 className="w-8 h-8 animate-spin mx-auto text-europbots-secondary" />
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <span
                            className={`px-2 py-1 rounded-full text-xs font-medium ${getProcessColor(
                              lead.process || ""
                            )}`}
                          >
